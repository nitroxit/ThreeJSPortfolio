...
const disciplines = ['Designer', 'Software Engineer', 'Innovator', 'Creator', 'Jazz Enthusiest']
    ...
    return (
        <div className="home">
            ...
            <ProjectSummary
                ...
                index={2}
                title="Rowan Fox"
                description="Aspiring tech enthusiast looking to constantly expand."
                buttonText="View Linkedin Profile"
                buttonLink="https://linkedin.com/in/rowan-fox-951230219"
                model={{
                    type: 'phone',
                    alt: 'rowan',
                    textures: [
